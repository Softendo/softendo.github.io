          ...
          <nav class="navigation">
            <div class="nav-wrapper">
              ...
              <ul class="left hide-on-med-and-down">
                <li><a href="index" class="tooltipped" data-position="bottom" data-delay="100" data-tooltip="Home" data-tooltip-id="a577f35a-6d21-f454-107a-773c2e550740"><i class="material-icons">home</i></a></li>
                                <li><a href="game.php?id=49" class="tooltipped" data-position="bottom" data-delay="100" data-tooltip="Play" data-tooltip-id="6ee76ec0-6f6b-5319-67e6-2bf9536fe236"><i class="material-icons">videogame_asset</i></a></li>
                
                                      
                <li class="active"><a href="levels" class="tooltipped" data-position="bottom" data-delay="100" data-tooltip="Levels" data-tooltip-id="d9007092-91f1-24b4-b1fe-f189e0408f8f"><i class="material-icons">view_list</i></a></li>
...
<ul><li><strong>Performance Upgrades: </strong>Requests for data have been optimized to ensure maximum performance when handling tasks. And fewer overall requests means less stress on the servers. This equates to faster load times for you. And we'll be continuing to improve speeds over the next few weeks.</li><li><strong> Introducing Private Comments: </strong>The private messages system and comments system have been combined into one. Simply check "Make this Private" before adding a comment.</li><li><strong>News: </strong> News posts are now visible on the front page.<br><br><strong>COMING SOON:</strong></li><li>Performance improvements on levels, level, and profile pages.</li><li>Notification Spam Prevention: Notifications automatically cleared after 2 weeks.</li><li>Pinned Comments</li><li>Design and layout enhancements</li> 
        ...
        <div class="fixed-action-btn hide-on-small-only" style="bottom: 25px; left: 25px; width: 55px;">
          <a class="btn-floating btn-large red undo-delete tooltipped" delete="" type="" data-position="top" data-delay="100" data-tooltip="Undo Delete" style="display: none;" data-tooltip-id="06a9caca-4c38-5b98-0cb5-f91108418413">
...
<div class="section ad-section responsive-ad">
  ...
  (adsbygoogle = window.adsbygoogle || []).push({});
         ...
         <div class="row"><div class="col s12"><div class="card"><div class="card-content align-center"><h3>No level found.</h3><h5>Nothing to see here. Move along.</h5></div></div></div></div>         
         <!--
...
<div class="material-tooltip" id="0a9026a8-4e1e-94bf-ba4b-c06f96dff5c6"><span>Home</span><div class="backdrop" style="top: 0px; left: 0px;"></div></div><div class="material-tooltip" id="d1260cf9-19d6-29c1-df94-0555a70a0730"><span>Play</span><div class="backdrop" style="top: 0px; left: 0px;"></div></div><div class="material-tooltip" id="699bacca-0e3f-45a6-3750-e56c25aab8a8"><span>Levels</span><div class="backdrop" style="top: 0px; left: 0px;"></div></div><div class="material-tooltip" id="5610f1d5-cf9b-694a-decc-a5622b6529e5"><span>Undo Delete</span><div class="backdrop" style="top: 0px; left: 0px;"></div></div><div class="hiddendiv common"></div><div class="drag-target" style="left: 0px; touch-action: pan-y; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);"></div><div class="material-tooltip" id="a577f35a-6d21-f454-107a-773c2e550740"><span>Home</span><div class="backdrop" style="top: 0px; left: 0px;"></div></div><div class="material-tooltip" id="6ee76ec0-6f6b-5319-67e6-2bf9536fe236"><span>Play</span><div class="backdrop" style="top: 0px; left: 0px;"></div></div><div class="material-tooltip" id="d9007092-91f1-24b4-b1fe-f189e0408f8f" style="opacity: 0; margin-top: 0px; margin-left: 0px; display: none;"><span>Levels</span><div class="backdrop" style="top: 0px; left: 0px; opacity: 0; transform: scale(1); display: none;"></div></div><div class="material-tooltip" id="06a9caca-4c38-5b98-0cb5-f91108418413"><span>Undo Delete</span><div class="backdrop" style="top: 0px; left: 0px;"></div></div></body></html>