...
console.log('Haxball Media Player is now running');
...
function playersToFollowList() {
  ...
  function logKey(ev) {
	...
	if (ev.which == 70 && ev.altKey) {
		alert('GIF Creator has been initiated');
		 haxracing = true;
  ...
  heatMap = function(par) {
	...
	if (canvas2.getContext) {
		...
		img2.src = 'https://softendo.github.io/hb/images/haxpitch4.png';
	}
  }
...
newCell.appendChild(newText);*/
	...
	a.get('staty').onclick = function () {
	  ...
	  setTimeout(function() {
		...
		if (canvas.getContext) {
			...
			img1.src = 'https://softendo.github.io/hb/images/haxpitch4.png';
		}
		var canvas2 = document.createElement("canvas");
		if (canvas2.getContext) {
  ...
  function Jb(a, b, c) {
    ...
    if (1212305971 != a.hb()) throw new q('');
    b = a.hb();
...
ba.Yl = function (a) {
var b = new Date;
Ca.ar(a, 'HBReplay-' + b.getFullYear() + '-' + J.Af('' + (b.getMonth() + 1)) + '-' + J.Af('' + b.getDate()) + '-' + J.Af('' + b.getHours()) + 'h' + J.Af('' + b.getMinutes()) + 'm.hb3')
};
ba.Bq = function (a) {
for (var b = a.T.I, c = [
...
T.Fo = function () {
return M.tk(/*n.Ee + 'api/geo'*/"https://softendo.github.io/hb/data/geo.json").then(function (a) {
  return T.Rf(a)
})
//return false;
};
...
b.Jp = function (b) {
  ...
  x.La((new P('Create room', 'Connecting...', [
  ])).g);
  var e = null,
  f = n.A.Lh(),
  g = new fa;
...
u.po = function (a) {
try {
  var b = new Vb(new Jb(new Uint8Array(a), new fa, 1));
  b.je.de = function () {
    b.ia();
    u.xb()
  };
  ...
  x.La(b.j.g)
    ...
    var d = new P('Haxball Media Player', 'Not a valid HBR3 replay file.', [
      'Ok'
    ]);
	d.Vd.innerHTML = '<img src="images/info.png">' + '<p>Not a valid HBR3 replay file format.</p>';
    x.La(d.g);
    d.Va = function () {
      d.Va = null;
      u.xb()
...
document.getElementsByClassName("bottom-section")[0].innerHTML = "<div id=\"room-view\" class=\"room-view\"><div class=\"container\"><h1 data-hook=\"room-name\">konakona</h1></div></div>"
//document.getElementsByClassName("bottom-section")[0].style.display="none"
...
return Promise.all([M.L('https://softendo.github.io/hb/data/res.dat', 'arraybuffer').then(function (a) {
a = new JSZip(a);
n.Na = new Ub(a);
...
va.get = function () {
return M.L(/*n.Ee + */'', 'arraybuffer').then(function (a) {
...
Da.N = '<div class=\'chatbox-view\'><div data-hook=\'log\' class=\'log\'><p>Controls:<br/>Move: WASD or Arrow keys<br/>Kick: X, Space, Ctrl, Shift, Numpad 0<br/>View: Numbers 1 to 4</p></div><div class=\'autocompletebox\' data-hook=\'autocompletebox\'></div><div class=\'input\'><input data-hook=\'input\' type=\'text\' /><button data-hook=\'send\'>Send</button></div></div>';
kb.N = '<div class=\'choose-nickname-view\'><img src="images/logo.png" /><div class=\'dialog\'><h1>Haxball Media Player</h1><div style=\'display: none\' class=\'label-input\'><label>Nick:</label><input data-hook=\'input\' type=\'text\' /></div><button id=\'button_ok\' data-hook=\'ok\'>Start</button></div></div>';
...
ha.N = '<div class=\'replay-controls-view\'><button id=\'reset_button\' data-hook=\'reset\'><span class=\'tooltip\'>Rewind</span><i class=\'icon-to-start\'></i></button><button id=\'play_button\' data-hook=\'play\'><span class=\'tooltip\'>Play/Pause</span><i data-hook=\'playicon\'></i></button><div data-hook=\'spd\'>1x</div><button id=\'spddown\' data-hook=\'spddn\'>-<span class=\'tooltip\'>Slower playback</span></button><button data-hook=\'spdup\'>+<span class=\'tooltip\'>Faster playback</span></button><div data-hook=\'time\'>00:00</div><div class=\'timebar\' data-hook=\'timebar\'><div class=\'barbg\'><div class=\'bar\' data-hook=\'progbar\'></div></div><div class=\'timetooltip\' data-hook=\'timetooltip\'></div></div><button id=\'button_leave\' data-hook=\'leave\'>Leave</button></div>';
...
aa.N = '<div class=\'dialog settings-view\'><h1>Settings</h1><button data-hook=\'close\'>Close</button><div class=\'tabs\'><button data-hook=\'soundbtn\'>Sound</button><button data-hook=\'videobtn\'>Video</button></div><div data-hook=\'presskey\' tabindex=\'-1\'><div>Press a key</div></div><div class=\'tabcontents\'><div class=\'section\' data-hook=\'miscsec\'><div class=\'loc\' data-hook=\'loc\'></div><div class=\'loc\' data-hook=\'loc-ovr\'></div><button data-hook=\'loc-ovr-btn\'></button></div><div class=\'section\' data-hook=\'soundsec\'><div data-hook="tsound-main">Sounds enabled</div><div data-hook="tsound-chat">Chat sound enabled</div><div data-hook="tsound-highlight">Nick highlight sound enabled</div><div data-hook="tsound-crowd">Crowd sound enabled</div></div><div class=\'section\' data-hook=\'inputsec\'></div><div class=\'section\' data-hook=\'videosec\'><div>Viewport Mode:<select data-hook=\'viewmode\'><option>Dynamic</option><option>Restricted 840x410</option><option>Full 1x Zoom</option><option>Full 1.25x Zoom</option><option>Full 1.5x Zoom</option><option>Full 1.75x Zoom</option><option>Full 2x Zoom</option><option>Full 2.25x Zoom</option><option>Full 2.5x Zoom</option></select></div><div>FPS Limit:<select data-hook=\'fps\'><option>None (Recommended)</option><option>30</option></select></div><div>Resolution Scaling:<select data-hook=\'resscale\'><option>100%</option><option>75%</option><option>50%</option><option>25%</option></select></div><div>Player To Follow:<select data-hook=\'follow\'>' + playersToFollowList() + '</select></div><div data-hook="tvideo-teamcol">Custom team colors enabled</div><div data-hook="tvideo-showindicators">Show chat indicators</div><div><button onclick=\'createGif()\' id=\'button_create_gif\'>Create GIF</button></div><div data-hook="tvideo-showavatars">Show player avatars</div></div></div></div>';
aa.$l = 0;
...
Xa.N = '<div class=\'stats-view\'><p>Fps: <span data-hook=\'fps\'></span></p><div data-hook=\'graph\'></div></div>';
