...
T.Fo = function () {
return M.tk(/*n.Ee + 'api/geo'*/"https://softendo.github.io/hb/pliki/geo.json").then(function (a) {
  return T.Rf(a)
})
//return false;
};
...
b.Jp = function (b) {
  ...
  var l = new Lb({
    iceServers: n.Vf,
    ij: 'https://softendo.github.io/hb/pliki/host.json',
	//ij: "pliki/host.json",
    state: g,
    version: 9
  });
...
return Promise.all([M.L('https://softendo.github.io/hb/pliki/res.dat', 'arraybuffer').then(function (a) {
a = new JSZip(a);
n.Na = new Ub(a);
...
va.get = function () {
return M.L(/*n.Ee + */'https://softendo.github.io/hb/pliki/geo.json', 'arraybuffer').then(function (a) {
...
Il: function () {
var a = this;
M.tk(/*n.Ee + 'api/notice'*/"https://softendo.github.io/hb/pliki/notice.json").then(function (b) {
var c = b.content;
...
n.Ee = 'https://softendo.github.io/hb/';
n.Vf = [
{
...
kb.N = '<div class=\'choose-nickname-view\'><img src="images/me-tan.png" /><div class=\'dialog\'><h1>Haxball Replay Player</h1><div style=\'display: none\' class=\'label-input\'><label>Nick:</label><input data-hook=\'input\' type=\'text\' /></div><button id=\'button_ok\' data-hook=\'ok\'>Start</button></div></div>';
